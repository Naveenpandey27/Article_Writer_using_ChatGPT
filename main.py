...
writing_style = st.selectbox("Select writing style:", ["Casual", "Informative", "Witty", "professional"])
word_count = st.slider("Select word count:", min_value=300, max_value=2000, step=100, value=300)
